...
- status: NEW | ACCEPTED | IN_PROGRESS | COMPLETED | CANCELLED | ARCHIVED
- priority: LOW | MEDIUM | HIGH | URGENT
- 支持子任务、自动上传配置

### Version（版本）
- version_number, file_count, total_size, delta_size
- upload_type: MANUAL | AUTO_SCHEDULED | AUTO_TRIGGERED
...
### ContentStore（内容存储）
- file_hash, storage_path, ref_count
- 用于去重和引用计数
